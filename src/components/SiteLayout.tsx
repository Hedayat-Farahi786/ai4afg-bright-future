...
export function PageHero({
  ...
  return (
    <section className="px-6 pt-20 pb-16 lg:pt-32 lg:pb-20 border-b border-zinc-950/5">
      <div className="max-w-7xl mx-auto">
        ...
        {lead && (
          <p className="mt-6 text-lg lg:text-xl text-zinc-600 max-w-[60ch] text-pretty leading-relaxed">
            {lead}
          </p>
        )}
      </div>
